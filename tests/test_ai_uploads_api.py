...
# 旧 TestAiLedgerContext (POST /api/v1/ai/ledger-context) は E3-F PR-D-6-1b で
# エンドポイント削除に伴い撤去。元帳テキスト構築のクライアント側移植先
# (crypto/ledger_context.js buildAccountsLedgerContext) は
# tests/static/js/test_ledger_context.mjs でカバーする。
